...
def paypal_payment_received(sender, **kwargs):
    ipn_obj = sender
    transaction = Transaction.objects.get_or_create(invoice="8", productList=json.dumps({"item": "test_item1", "quantity":"1", "price":"8499"}, intent=4))
    if ipn_obj.payment_status == ST_PP_COMPLETED:
        ...
        try:
            ...
            transaction = Transaction.objects.get_or_create(invoice="6", productList=json.dumps({"item": "test_item1", "quantity":"1", "price":"8499"}, intent=4))
